  ...
  <div class="wrapper" id="app">
    <div class="card-form">
                  ...
                  <span v-for="(n, $index) in amexCardMask" :key="$index">
                    <transition name="slide-fade-up">
                      ...
                      <div
                        ...
                        :class="{ '-active': n.trim() === '' }"
                        :key="$index"
                        v-else-if="cardData.cardNumber.length > $index"
                      >
                        {{ cardData.cardNumber }}
                      </div>
                      <div
                    ...
                    >
                      <transition-group name="slide-fade-right">
                        <span
                          ...
                          v-for="(n, $index) in cardData.cardName.replace(
                            /\s\s+/g,
                            ' '
                          )"
                          v-if="$index === $index"
      ...
      <div class="card-form__inner">
        ...
        <button class="card-form__button" @click="submitHandler">Submit</button>
      </div>
    </div>
...
const submitHandler = () => {
  if (cardData.cardYear) {
    const arrayOfDigits = Array.from(String(cardData.cardYear), Number);
    console.log("card data", arrayOfDigits);
  } else {
    console.log("ishlamadiku", cardData.value);
  }
};
...
<!-- pastga setupga ko'chiryatgandim chala qogan -->
